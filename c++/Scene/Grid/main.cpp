...
int main()
{
    ...
    Object  obj1(1, Vec2(15, 25), AABB{Vec2(9, 20), Vec2(21, 31)});     // 10,20 --> 20 30
    Object  obj3(3, Vec2(100, 100), AABB{Vec2(90, 90), Vec2(110, 110)}); // 90,90 --> 100 100
    Object  obj2(2, Vec2(22, 35), AABB{Vec2(20, 30), Vec2(30, 45)});     // 20,30 --> 30 40
    Object  obj4(4, Vec2(35, 34), AABB{Vec2(25, 30), Vec2(40, 40)});     // 30,30 --> 40 40
    Object  obj5(5, Vec2(42, 35), AABB{Vec2(30, 30), Vec2(50, 40)});     // 40,30 --> 50 40
    Object  obj6(6, Vec2(25, 45), AABB{Vec2(20, 40), Vec2(30, 50)});     // 20,40 --> 30 50
    Object  obj7(7, Vec2(35, 45), AABB{Vec2(30, 40), Vec2(40, 50)});     // 30,40 --> 40 50
    Object  obj8(8, Vec2(45, 45), AABB{Vec2(40, 40), Vec2(50, 50)});     // 40,40 --> 50 50
    Object  obj9(9, Vec2(25, 25), AABB{Vec2(20, 20), Vec2(30, 30)});     // 20,20 --> 30 30
    Object  obj10(10, Vec2(35, 25), AABB{Vec2(30, 20), Vec2(40, 30)});   // 30,20 --> 40 30
    Object  obj11(11, Vec2(45, 25), AABB{Vec2(40, 20), Vec2(50, 30)});   // 40,20 --> 50 30
    Object  obj12(12, Vec2(45, 25), AABB{Vec2(40, 20), Vec2(50, 30)});   // 40,20 --> 50 30
    Object  obj13(13, Vec2(55, 45), AABB{Vec2(50, 40), Vec2(60, 50)});   // 50,40 --> 60 50
    Object  obj14(14, Vec2(5, 5), AABB{Vec2(0, 0), Vec2(10, 10)});       // 0,0 --> 10 10

    // 检查目标对象是否在视锥内
    std::vector<Object> objects = {obj1, obj2, obj3, obj4, obj5, obj6, obj7, obj8, obj9, obj10, obj11, obj12, obj13, obj14};
    // std::vector<Object> objects = {obj1};
    ...
    auto objs = grid.GetObjects(Vec2(1, 1));

    std::cout<<"obj count: "<<objs.size()<<std::endl;
