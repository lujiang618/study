...
void CreatePipeline(VkExtent2D canvasSize)
{
    ...
    pipelineCiPack.createInfo.renderPass         = RenderPassAndFramebuffer_Offscreen(canvasSize).renderPass_;
    ...
    pipelineCiPack.colorBlendAttachmentStates.push_back({
        ...
        .colorWriteMask = 0b1111 // 初始化 colorWriteMask
    });
    ...
    auto Create = []
    {
        ...
        pipelineCiPack.createInfo.renderPass         = RenderPassAndFramebuffers_Screen().renderPass_;
